...
#ifndef McuWait_CONFIG_NOF_CYCLES_FOR_NOP
  #define McuWait_CONFIG_NOF_CYCLES_FOR_NOP   (1)
	/*!< by default, use a single cycle for a NOP instruction. Some devices like the LPC804 need 2 cycles */
#endif
